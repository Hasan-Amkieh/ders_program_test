...
Map<String, String> engToTurk = {
  ...
  "Fri" : "Cum",
  "Sat" : "Cmt",
  "Edit Courses" : "Dersleri düzenle",
  "Scheduler" : "Zamanlayıcı",
  "Choose Made-up Plans" : "Hazır Planları Seçin",
  "Search for Courses" : "Dersler Ara",
  "Saved Schedules" : "Kayıtlı Programlar",
  "Add and edit the courses on the current schedule" : "Mevcut takvimdaki dersleri ekleyin ve düzenleyin",
  "Choose the courses with the sections you prefer, then choose your appropriate schedule" : "Tercih ettiğiniz şubelere sahip dersleri seçin, ardından uygun programınızı seçin",
  ...
  "Only search courses for this department" : "Sadece bu bölüm için ders ara",
  "OK" : "TAMAM",
  "ADD TO FAVOURITES" : "FAVORİLERE EKLE",
  "Added to favourite courses" : "Favori derslere eklendi",
  "Course code, teacher name or classroom" : "Ders kodu, öğretmen adı veya sınıf",
  "Favourite Courses" : "Favori Dersler",
  "The course is already a favourite" : "Ders zaten favori",
  "You have no favourite courses, please add them from Search for Courses page" : "Favori dersiniz yok, lütfen Ders Ara sayfasından ekleyin",
  "REMOVE" : "KALDIR",
  "course name" : "Ders adı",
  "course name/code" : "Ders adı/Kod",
  "teacher" : "öğretmen",
  "classroom" : "Sınıf",
  "ADD TO SCHEDULE" : "TAKVİME EKLE",
  "Added to the current schedule" : "Mevcut takvime eklendi",
  "The course is already in the schedule" : "Ders zaten takvimde",
  "NOT NOW" : "ŞİMDİ DEĞİL",
  ...
  "Show courses only for" : "Dersleri yalnızca şunun için göster",
  "course code or name" : "ders kodu veya adı",
  "Notes" : "Notlar",
  "Close" : "Kapat",
  "Department/Tag" : "Bölüm/Etiket",
  "The course code " : "Ders kodu",
  ...
  "No courses to show" : "Gösterilecek ders yok",
  "Search" : "Arama",
  " or " : " yoksa ",
  ...
  "The course has no time data" : "derste zaman verisi yok",
