...
const List<List<Color>> whiteThemeScheduleColors = [
  ...
  [Color.fromRGBO(104, 210, 102, 1.0), Colors.white],
  ...
  [Color.fromRGBO(52, 66, 75, 1.0), Colors.white],
  [Color.fromRGBO(212, 168, 87, 1.0), Colors.white],
  [Color.fromRGBO(84, 125, 141, 1.0), Colors.white],
  [Color.fromRGBO(102, 132, 89, 1.0), Colors.white],
  [Color.fromRGBO(127, 66, 58, 1.0), Colors.white],
];
